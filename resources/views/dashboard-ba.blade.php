    ...
    <div class="container">
        ...
        <aside class="sidebar">
            <div>
                ...
                <nav class="menu">
                    <a href="/dashboard-ba" class="active">Dashboard</a>
        ...
        <main class="main-content">
            ...
            <section class="stats-grid">
                <div class="stats-card">
                    <h2>Jumlah Ruang Kuliah Terpakai</h2>
                    <p>15</p>
                </div>
                <div class="stats-card">
                    <h2>Jumlah Ruang Kuliah Tidak Terpakai</h2>
                    <p>3</p>
                </div>
                <div class="stats-card">
                    <h2>Persentase Ruang Kuliah Terpakai</h2>
                    <p>83%</p>
                </div>
                <div class="stats-card">
                    <h2>Total Kapasitas Ruang</h2>
                    <p>675</p>
                </div>
                <div class="stats-card">
                    <h2>Rerata Kapasitas Tiap Ruang</h2>
                    <p>45</p>
                </div>
            </section>
        </main>
